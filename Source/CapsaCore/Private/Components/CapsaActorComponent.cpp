...
void UCapsaActorComponent::ServerRegisterLinkedCapsaLog_Implementation(const FCapsaSharedData& ClientCapsaData)
{
	...
	UE_LOG(LogCapsaCore, Log, TEXT("UCapsaActorComponent::ServerRegisterLinkedCapsaLog_Implementation | OldCapsaId: %s, NewCapsaId: %s"), *OldCapsaId,
		*NewCapsaId);
	...
	UE_LOG(LogCapsaCore, Log, TEXT("UCapsaActorComponent::ServerRegisterLinkedCapsaLog_Implementation | Adding linked log with ID: %s, Description: %s"),
		*ClientCapsaData.LogID, *ClientCapsaData.Description);
...
void UCapsaActorComponent::BeginPlay()
{
	...
	CapsaData = FCapsaSharedData(CapsaLogId, CapsaLogURL, GetDefaultDescription(bIsServer));
